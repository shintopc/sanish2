...
function navigateToPurchaseList() {
    ...
    document.getElementById('shareMenuPage').classList.add('hidden');
}

function navigateToShareMenu() {
    document.getElementById('homePage').classList.add('hidden');
    document.getElementById('purchaseListPage').classList.add('hidden');
    document.getElementById('shareMenuPage').classList.remove('hidden');
}
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    document.getElementById('shareWhatsApp').addEventListener('click', shareMenuToWhatsApp);
    document.getElementById('exportMenuPDF').addEventListener('click', exportMenuToPdf);
});
